                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form x-data="{
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col col-md-9">
                                            <div class="form-check">
                                                ...
                                                <div class="radio">
                                                    <label for="radio2" class="form-check-label" @click="one=false; multi=true; fill=false; sequence=false;">
                                                        <input type="radio" id="radio2" name="type" value="multi" class="form-check-input"> Multiple choices
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label for="radio3" class="form-check-label" @click="one=false; multi=false; fill=true; sequence=false;">
                                                        <input type="radio" id="radio3" name="type" value="fill" class="form-check-input"> Fill the blank
                                                    </label>
                                                </div>

                                                <div class="radio">
                                                    <label for="radio4" class="form-check-label" @click="one=false; multi=false; fill=false; sequence=true;">
                                                        <input type="radio" id="radio4" name="type" value="sequence" class="form-check-input"> Sequences
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <template x-if="sequence" x-data="{ options:[{id: 1}], answers:[{id: 1}] }">
                                        <div class="toShow">
                                            <template x-for="(option,index) in options">
                                                <div class="row form-group">
                                                    <div class="col col-md-3"></div>
