...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 08, 2022 lúc 02:13 PM
...
(104, 'fill', '<p>Kết quả biểu thức l&agrave;?</p><p><span style=\"color: rgb(251, 160, 38);\"><span class=\"fr-class-code\">typeof(3) === typeof(4.32);</span></span></p>', '', 'true', 'trungbinh'),
(107, 'sequence', '<p>Sắp xếp để được một th&agrave;nh ngữ</p>', 'a:4:{i:0;s:5:\"Khôn\";i:1;s:4:\"Nhà\";i:2;s:5:\"Dại\";i:3;s:5:\"Chợ\";}', '', 'coban'),
(108, 'sequence', '<p>sắp xếp để được một th&agrave;nh ngữ</p>', 'a:4:{i:0;s:1:\"A\";i:1;s:1:\"B\";i:2;s:1:\"C\";i:3;s:1:\"D\";}', '', 'coban');
...
(1, 'JavaScript cơ bản đề số 1', 7, 13, 5, 2),
(2, 'JavaScript cơ bản đề số 2', 7, 10, 8, 2),
(3, 'JavaScript vận dụng đề số 1', 8, 3, 11, 6),
(4, 'JavaScript vận dụng đề số 2', 8, 8, 10, 2),
(9, 'JavaScript nâng cao - đề số 1', 9, 2, 2, 16),
(10, 'JavaScript cơ bản đề số 3', 7, 5, 5, 10);
...
CREATE TABLE `gio_hang` (
  ...
  `id_khoa_hoc` int(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `gio_hang` (`id`, `username`, `id_khoa_hoc`) VALUES
(10, 'dathoi2019', 7),
(12, 'dathoi2018', 8),
(13, 'dathoi2018', 9),
(16, 'admin.khanh', 7),
...
(24, 'dathoi2019', 7, 2, 2, '2021-12-30 12:35:12'),
(25, 'dathoi2018', 7, 1, 0, '2021-12-30 13:56:56'),
(26, 'dathoi2018', 7, 1, 3, '2021-12-30 13:57:22'),
(27, 'dathoi2018', 7, 1, 1, '2021-12-30 14:04:56'),
(28, 'dathoi2019', 7, 2, 3, '2021-12-31 03:02:06'),
(29, 'longdz', 7, 1, 8, '2022-01-07 00:42:30');
...
(5, 'dathoi2019', 'Nguyễn Ngọc Hà', 'thankhuya5@gmail.com', '123456', 'admin'),
(6, 'longdz', 'Nguyễn Ngọc Lan', 'Longngoc@gmail.com', '123456', 'user'),
...
--
ALTER TABLE `de_thi`
  MODIFY `ma_de_thi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
